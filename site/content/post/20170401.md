...
---
<img style="float: left; margin:0 1em 1em 0; width: 33%" src="/img/blog/teamcity.jpg"/>
...
5. Using external database (https://confluence.jetbrains.com/display/TCD10/Setting+up+an+External+Database)
